...
{% block tex-documentbody %}
    ...
    % BEGIN MONDAY
        \begin{minipage}[c]{\textwidth}%
            \WeekOnDoublePageDayMetaLeft{ {{ w.days.0.date.day|stringformat:'02d' }} }{ {{ w.days.0.date|date:"l" }} }{ {% for h in w.days.0.holidays %}{{ h }}{% if forloop.last %} {% else %} - {% endif %}{% endfor %} }
            \WeekOnDoublePageMainSpace{ {% for b in w.days.0.annuals %}{{ b }} \\ {% endfor %} }
        \end{minipage}%
        \newline%
    ...
    % BEGIN TUESDAY
        \begin{minipage}[c]{\textwidth}%
            \WeekOnDoublePageDayMetaLeft{ {{ w.days.1.date.day|stringformat:'02d' }} }{ {{ w.days.1.date|date:"l" }} }{ {% for h in w.days.1.holidays %}{{ h }}{% if forloop.last %} {% else %} - {% endif %}{% endfor %} }
            \WeekOnDoublePageMainSpace{ {% for b in w.days.1.annuals %}{{ b }} \\ {% endfor %} }
        \end{minipage}%
        \newline%
        \rule{\textwidth}{\WeekOnDoublePageDaySeperatorThickness}%
    % END TUESDAY
    ...
    % BEGIN WEDNESDAY
        \begin{minipage}[c]{\textwidth}%
            \WeekOnDoublePageDayMetaLeft{ {{ w.days.2.date.day|stringformat:'02d' }} }{ {{ w.days.2.date|date:"l" }} }{ {% for h in w.days.2.holidays %}{{ h }}{% if forloop.last %} {% else %} - {% endif %}{% endfor %} }
            \WeekOnDoublePageMainSpace{ {% for b in w.days.2.annuals %}{{ b }} \\ {% endfor %} }
        \end{minipage}%
    % END WEDNESDAY
    ...
    % BEGIN THURSDAY
        \begin{minipage}[c]{\textwidth}%
            \WeekOnDoublePageDayMetaRight{ {{ w.days.3.date.day|stringformat:'02d' }} }{ {{ w.days.3.date|date:"l" }} }{ {% for h in w.days.3.holidays %}{{ h }}{% if forloop.last %} {% else %} - {% endif %}{% endfor %} }
            \WeekOnDoublePageMainSpace{ {% for b in w.days.3.annuals %}{{ b }} \\ {% endfor %} }
        \end{minipage}%
        \newline%
        \rule{\textwidth}{\WeekOnDoublePageDaySeperatorThickness}%
    % END THURSDAY
    ...
    % BEGIN FRIDAY
        \begin{minipage}[c]{\textwidth}%
            \WeekOnDoublePageDayMetaRight{ {{ w.days.4.date.day|stringformat:'02d' }} }{ {{ w.days.4.date|date:"l" }} }{ {% for h in w.days.4.holidays %}{{ h }}{% if forloop.last %} {% else %} - {% endif %}{% endfor %} }
            \WeekOnDoublePageMainSpace{ {% for b in w.days.4.annuals %}{{ b }} \\ {% endfor %} }
        \end{minipage}%
        \newline%
        \rule{\textwidth}{\WeekOnDoublePageDaySeperatorThickness}%
    % END FRIDAY
    ...
    % BEGIN WEEKEND - SATURDAY
        \begin{minipage}[c]{0.5\textwidth}%
            \WeekOnDoublePageDayMetaRight{ {{ w.days.5.date.day|stringformat:'02d' }} }{ {{ w.days.5.date|date:"l" }} }{ {% for h in w.days.5.holidays %}{{ h }}{% if forloop.last %} {% else %} - {% endif %}{% endfor %} }
            \WeekOnDoublePageMainSpace{ {% for b in w.days.5.annuals %}{{ b }} \\ {% endfor %} }
        \end{minipage}%
    % END SATURDAY - BEGIN SUNDAY
        \begin{minipage}[c]{0.5\textwidth}%
            \WeekOnDoublePageDayMetaRight{ {{ w.days.6.date.day|stringformat:'02d' }} }{ {{ w.days.6.date|date:"l" }} }{ {% for h in w.days.6.holidays %}{{ h }}{% if forloop.last %} {% else %} - {% endif %}{% endfor %} }
            \WeekOnDoublePageMainSpace{ {% for b in w.days.6.annuals %}{{ b }} \\ {% endfor %} }
        \end{minipage}%
